...
Research page는 결과를 주장하는 곳이 아니라 질문을 좁히는 곳입니다. 공개 논문, 공개 benchmark, 재현 가능한 최소 실험으로 검토할 수 있는 문제만 남깁니다.
...
각 질문은 아직 결과 claim이 아닙니다. 공개 논문, 공개 benchmark, 또는 공개 가능한 최소 실험으로 검증될 때 paper review, project, post로 이어집니다.
...
| Boundary | 공개 문맥만으로 이해되어야 하며, 공개할 수 없는 세부 정보에 의존하지 않아야 합니다. |
