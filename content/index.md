...
| [Molecular Modeling](/bio) | docking, conformers, molecules, proteins, ligand interaction, structure-based modeling |
...
- Molecular modeling: [[bio/index|Molecular Modeling]] -> [[bio/structure-based-ai|Structure-based modeling]] -> [[bio/docking|Docking]] -> [[concepts/sbdd/index|SBDD concepts]]
- Protein modeling: [[bio/proteins|Proteins]] -> [[concepts/protein-modeling/index|Protein modeling concepts]]
...
예를 들어 docking 글은 [[bio/index|Molecular Modeling]]에서 시작해 [[bio/structure-based-ai|Structure-based modeling]], [[bio/docking|Docking]], [[concepts/sbdd/scoring-function|Scoring function]], [[papers/sbdd/posebusters|PoseBusters]] 같은 내부 노트로 이어집니다.
