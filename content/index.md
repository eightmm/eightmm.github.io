...
| [Bio-AI](/bio) | structure-based AI, molecules, proteins, ligand interaction, genome-level sequence |
...
- Bio-AI: [[bio/index|Bio-AI]] -> [[bio/structure-based-ai|Structure-based AI]] -> [[bio/docking|Docking]] -> [[concepts/sbdd/index|SBDD concepts]]
...
예를 들어 구조 기반 AI 글은 [[bio/index|Bio-AI]]에서 시작해 [[bio/structure-based-ai|Structure-Based AI]], [[bio/docking|Docking]], [[concepts/sbdd/scoring-function|Scoring function]], [[papers/sbdd/posebusters|PoseBusters]] 같은 내부 노트로 이어집니다.
