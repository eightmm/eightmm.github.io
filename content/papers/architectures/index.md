...
| State-space, retention, moving-average, and long-convolution sequence models | recurrent state, convolution view, EMA state, retention state, long-range sequence modeling, implicit long filters, selective scan lineage, structured state-space duality, hybrid attention-SSM allocation | [S4](/papers/architectures/s4), [Mega](/papers/architectures/mega), [Hyena](/papers/architectures/hyena), [RetNet](/papers/architectures/retnet), [Mamba](/papers/architectures/mamba), [Mamba-2](/papers/architectures/mamba-2), [Jamba](/papers/architectures/jamba) |
