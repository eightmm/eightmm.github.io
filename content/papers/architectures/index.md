...
| Generative architectures | autoregressive density, discrete latents, denoising, latent variables, adversarial games, style-based synthesis, invertible flows, iterative sampling, latent-space generation, distribution modeling | [PixelRNN and PixelCNN](/papers/architectures/pixel-recurrent-neural-networks), [Auto-Encoding Variational Bayes](/papers/architectures/auto-encoding-variational-bayes), [VQ-VAE](/papers/architectures/neural-discrete-representation-learning), [Generative Adversarial Nets](/papers/architectures/generative-adversarial-nets), [StyleGAN](/papers/architectures/stylegan), [Real NVP](/papers/architectures/real-nvp), [Glow](/papers/architectures/glow), [DDPM](/papers/architectures/ddpm), [Latent Diffusion Models](/papers/architectures/latent-diffusion-models) |
