...
| Graphs, sets, geometric models, and multimodal arrays | permutation behavior, message passing, equivariance, unordered inputs, latent bottlenecks | [GCN](/papers/architectures/gcn), [Graph Attention Networks](/papers/architectures/graph-attention-networks), [E(n) Equivariant GNN](/papers/architectures/egnn), [Deep Sets](/papers/architectures/deep-sets), [Set Transformer](/papers/architectures/set-transformer), [Perceiver IO](/papers/architectures/perceiver-io) |
