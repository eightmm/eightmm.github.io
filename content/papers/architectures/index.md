...
| Agent and control route | [DQN](/papers/architectures/human-level-control-through-deep-reinforcement-learning) | [World Models](/papers/architectures/world-models), [LSTM](/papers/architectures/long-short-term-memory), [Differentiable Neural Computer](/papers/architectures/differentiable-neural-computer) |
...
| Agent, value, and world-model architectures | observation encoders, action-value heads, replay versus differentiable memory, latent state compression, probabilistic dynamics, imagined rollouts, and controller/model boundaries | [DQN](/papers/architectures/human-level-control-through-deep-reinforcement-learning), [World Models](/papers/architectures/world-models), [Neural Turing Machines](/papers/architectures/neural-turing-machines), [Differentiable Neural Computer](/papers/architectures/differentiable-neural-computer) |
