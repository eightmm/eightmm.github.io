...
| State-space, retention, and long-convolution sequence models | recurrent state, convolution view, retention state, long-range sequence modeling, implicit long filters, selective scan lineage | [S4](/papers/architectures/s4), [Hyena](/papers/architectures/hyena), [RetNet](/papers/architectures/retnet), [Mamba](/papers/architectures/mamba) |
