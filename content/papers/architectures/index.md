...
| --- | --- | --- |
| Transformer backbone route | [Sequence to Sequence Learning](/papers/architectures/sequence-to-sequence-learning), [Attention Is All You Need](/papers/architectures/attention-is-all-you-need) | [Bahdanau Attention](/papers/architectures/neural-machine-translation-align-translate), [BERT](/papers/architectures/bert), [GPT-2](/papers/architectures/gpt-2), [T5](/papers/architectures/t5), [LLaMA](/papers/architectures/llama) |
| Iterative Transformer route | [Attention Is All You Need](/papers/architectures/attention-is-all-you-need) | [Universal Transformers](/papers/architectures/universal-transformers), [Transformer-XL](/papers/architectures/transformer-xl), [Neural ODE](/papers/architectures/neural-ode), [Mamba](/papers/architectures/mamba) |
| Variable-output and entity-routing route | [Pointer Networks](/papers/architectures/pointer-networks) | [Dynamic Routing Between Capsules](/papers/architectures/dynamic-routing-between-capsules), [Set Transformer](/papers/architectures/set-transformer), [DETR](/papers/architectures/detr), [Graphormer](/papers/architectures/graphormer) |
| Shared representation and metric-learning route | [Siamese Neural Networks](/papers/architectures/siamese-neural-networks-for-one-shot-image-recognition) | [FaceNet](/papers/architectures/facenet), [CLIP](/papers/architectures/clip), [GraphSAGE](/papers/architectures/graphsage) |
| Memory and retrieval route | [Long Short-Term Memory](/papers/architectures/long-short-term-memory), [Neural Turing Machines](/papers/architectures/neural-turing-machines) | [Memory Networks](/papers/architectures/memory-networks), [End-To-End Memory Networks](/papers/architectures/end-to-end-memory-networks), [Differentiable Neural Computer](/papers/architectures/differentiable-neural-computer), [Hopfield Networks is All You Need](/papers/architectures/hopfield-networks-is-all-you-need), [Attention Is All You Need](/papers/architectures/attention-is-all-you-need), [Transformer-XL](/papers/architectures/transformer-xl), [Perceiver IO](/papers/architectures/perceiver-io) |
| Efficient attention and recurrent sequence route | [Transformer-XL](/papers/architectures/transformer-xl) | [Longformer](/papers/architectures/longformer), [BigBird](/papers/architectures/bigbird), [Reformer](/papers/architectures/reformer), [Linformer](/papers/architectures/linformer), [Performer](/papers/architectures/performer), [FlashAttention](/papers/architectures/flashattention), [Gated Linear Attention](/papers/architectures/gated-linear-attention), [DeltaNet](/papers/architectures/deltanet), [Griffin](/papers/architectures/griffin), [Mega](/papers/architectures/mega), [RWKV](/papers/architectures/rwkv), [RetNet](/papers/architectures/retnet), [S4](/papers/architectures/s4), [Hyena](/papers/architectures/hyena), [Mamba](/papers/architectures/mamba), [Mamba-2](/papers/architectures/mamba-2), [Jamba](/papers/architectures/jamba) |
| CNN and vision backbone route | [LeNet-5](/papers/architectures/gradient-based-learning-applied-to-document-recognition), [AlexNet](/papers/architectures/alexnet) | [VGG](/papers/architectures/vgg), [Network In Network](/papers/architectures/network-in-network), [Inception](/papers/architectures/inception), [Highway Networks](/papers/architectures/highway-networks), [ResNet](/papers/architectures/deep-residual-learning), [Vision Transformer](/papers/architectures/vision-transformer), [Swin Transformer](/papers/architectures/swin-transformer), [CoAtNet](/papers/architectures/coatnet), [ConvNeXt](/papers/architectures/convnext) |
...
| Agent and control route | [DQN](/papers/architectures/human-level-control-through-deep-reinforcement-learning) | [World Models](/papers/architectures/world-models), [Dreamer](/papers/architectures/dream-to-control-learning-behaviors-by-latent-imagination), [MuZero](/papers/architectures/mastering-atari-go-chess-and-shogi-by-planning-with-a-learned-model), [AlphaZero](/papers/architectures/mastering-chess-and-shogi-by-self-play), [LSTM](/papers/architectures/long-short-term-memory), [Differentiable Neural Computer](/papers/architectures/differentiable-neural-computer) |
| Architecture search route | [Neural Architecture Search with Reinforcement Learning](/papers/architectures/neural-architecture-search-with-reinforcement-learning) | [EfficientNet](/papers/architectures/efficientnet), [Architecture selection](/concepts/architectures/architecture-selection), [Computational complexity](/concepts/architectures/computational-complexity) |

## Shelves

| Shelf | Read For | Anchor Papers |
| --- | --- | --- |
| Sequence and recurrent models | recurrence, gated memory, token mixing, encoder-decoder transduction, causal convolution, long convolution, moving average memory, recurrent language modeling, retention, positional encoding, language-model backbone design, prompt-as-interface behavior, long-context memory, efficient attention, state-space sequence modeling, structured matrix mixers, hybrid Transformer-SSM backbones | [Long Short-Term Memory](/papers/architectures/long-short-term-memory), [RNN Encoder-Decoder](/papers/architectures/rnn-encoder-decoder), [Sequence to Sequence Learning](/papers/architectures/sequence-to-sequence-learning), [Bahdanau Attention](/papers/architectures/neural-machine-translation-align-translate), [WaveNet](/papers/architectures/wavenet), [Attention Is All You Need](/papers/architectures/attention-is-all-you-need), [BERT](/papers/architectures/bert), [DeBERTa](/papers/architectures/deberta), [T5](/papers/architectures/t5), [GPT-2](/papers/architectures/gpt-2), [GPT-3](/papers/architectures/gpt-3), [Transformer-XL](/papers/architectures/transformer-xl), [Longformer](/papers/architectures/longformer), [BigBird](/papers/architectures/bigbird), [Reformer](/papers/architectures/reformer), [Linformer](/papers/architectures/linformer), [RoFormer](/papers/architectures/roformer), [ALiBi](/papers/architectures/alibi), [Performer](/papers/architectures/performer), [FlashAttention](/papers/architectures/flashattention), [Gated Linear Attention](/papers/architectures/gated-linear-attention), [DeltaNet](/papers/architectures/deltanet), [Griffin](/papers/architectures/griffin), [Mega](/papers/architectures/mega), [RWKV](/papers/architectures/rwkv), [RetNet](/papers/architectures/retnet), [S4](/papers/architectures/s4), [Hyena](/papers/architectures/hyena), [LLaMA](/papers/architectures/llama), [Layer Normalization](/papers/architectures/layer-normalization), [RMSNorm](/papers/architectures/root-mean-square-layer-normalization), [Mamba](/papers/architectures/mamba), [Mamba-2](/papers/architectures/mamba-2), [Jamba](/papers/architectures/jamba) |
| Associative memory and retrieval | content-addressable memory, attractor dynamics, differentiable external memory, soft read/write, allocation, temporal links, multi-hop retrieval, energy-based retrieval, and attention as a memory operation | [Memory Networks](/papers/architectures/memory-networks), [End-To-End Memory Networks](/papers/architectures/end-to-end-memory-networks), [Neural Turing Machines](/papers/architectures/neural-turing-machines), [Differentiable Neural Computer](/papers/architectures/differentiable-neural-computer), [Hopfield Networks is All You Need](/papers/architectures/hopfield-networks-is-all-you-need), [Attention Is All You Need](/papers/architectures/attention-is-all-you-need), [Transformer-XL](/papers/architectures/transformer-xl) |
| Structured output and entity routing | input-dependent output dictionaries, pointer distributions, permutation constraints, vector-valued entities, part-to-whole votes, routing-by-agreement, and iterative coupling | [Pointer Networks](/papers/architectures/pointer-networks), [Dynamic Routing Between Capsules](/papers/architectures/dynamic-routing-between-capsules), [Set Transformer](/papers/architectures/set-transformer), [DETR](/papers/architectures/detr) |
| Agent, value, and world-model architectures | observation encoders, action-value heads, policy/value heads, tree search, replay versus differentiable memory, latent state compression, task-oriented dynamics, imagined rollouts, differentiable actor-critic learning, and controller/model boundaries | [DQN](/papers/architectures/human-level-control-through-deep-reinforcement-learning), [AlphaZero](/papers/architectures/mastering-chess-and-shogi-by-self-play), [World Models](/papers/architectures/world-models), [Dreamer](/papers/architectures/dream-to-control-learning-behaviors-by-latent-imagination), [MuZero](/papers/architectures/mastering-atari-go-chess-and-shogi-by-planning-with-a-learned-model), [Neural Turing Machines](/papers/architectures/neural-turing-machines), [Differentiable Neural Computer](/papers/architectures/differentiable-neural-computer) |
| Iterative depth and adaptive computation | shared transition blocks, depth recurrence, time-step representations, learned halting, ponder cost, early exit, and compute-quality trade-offs | [Universal Transformers](/papers/architectures/universal-transformers), [Neural ODE](/papers/architectures/neural-ode), [Mixture of Experts](/papers/architectures/switch-transformer) |
| Attention variants and positional mechanisms | alignment, scaled dot-product attention, recurrence memory, moving-average local bias, sparse local/global/random attention, LSH attention, low-rank attention, disentangled content-position attention, relative/rotary position handling, linear attention bias, linear attention approximations, gated linear attention, delta-rule linear attention, IO-aware exact attention, key/value head sharing | [Bahdanau Attention](/papers/architectures/neural-machine-translation-align-translate), [Attention Is All You Need](/papers/architectures/attention-is-all-you-need), [Transformer-XL](/papers/architectures/transformer-xl), [DeBERTa](/papers/architectures/deberta), [Longformer](/papers/architectures/longformer), [BigBird](/papers/architectures/bigbird), [Reformer](/papers/architectures/reformer), [Linformer](/papers/architectures/linformer), [RoFormer](/papers/architectures/roformer), [ALiBi](/papers/architectures/alibi), [Performer](/papers/architectures/performer), [Gated Linear Attention](/papers/architectures/gated-linear-attention), [DeltaNet](/papers/architectures/deltanet), [FlashAttention](/papers/architectures/flashattention), [Mega](/papers/architectures/mega), [GQA](/papers/architectures/gqa) |
| Feed-forward and gating blocks | token-wise channel mixing, token-axis MLP mixing, MetaFormer scaffold, activation choice, learned piecewise-linear units, gated skip paths, gated MLPs, dense and sparse expert blocks | [Maxout Networks](/papers/architectures/maxout-networks), [Highway Networks](/papers/architectures/highway-networks), [MetaFormer](/papers/architectures/metaformer), [MLP-Mixer](/papers/architectures/mlp-mixer), [GELU](/papers/architectures/gelu), [GLU Variants Improve Transformer](/papers/architectures/glu-variants-improve-transformer), [Sparsely-Gated MoE](/papers/architectures/sparsely-gated-moe), [GShard](/papers/architectures/gshard), [Switch Transformer](/papers/architectures/switch-transformer), [GLaM](/papers/architectures/glam), [LLaMA](/papers/architectures/llama) |
| State-space, retention, moving-average, and long-convolution sequence models | recurrent state, convolution view, EMA state, retention state, gated linear-attention state, delta-rule matrix memory, local-attention hybrids, long-range sequence modeling, implicit long filters, selective scan lineage, structured state-space duality, hybrid attention-SSM allocation | [S4](/papers/architectures/s4), [Mega](/papers/architectures/mega), [Gated Linear Attention](/papers/architectures/gated-linear-attention), [DeltaNet](/papers/architectures/deltanet), [Griffin](/papers/architectures/griffin), [Hyena](/papers/architectures/hyena), [RetNet](/papers/architectures/retnet), [Mamba](/papers/architectures/mamba), [Mamba-2](/papers/architectures/mamba-2), [Jamba](/papers/architectures/jamba) |
| Vision backbones | locality, weight sharing, depth, width, connectivity, cardinality, channel recalibration, dense prediction, efficient mobile blocks, patch tokenization, token/channel MLP mixing, MetaFormer scaffold, convolution-attention hybrid staging, hierarchy, self-supervised ViT representation learning, masked image pre-training, post-ViT ConvNet modernization | [LeNet-5](/papers/architectures/gradient-based-learning-applied-to-document-recognition), [AlexNet](/papers/architectures/alexnet), [VGG](/papers/architectures/vgg), [Network In Network](/papers/architectures/network-in-network), [Inception](/papers/architectures/inception), [Xception](/papers/architectures/xception), [Highway Networks](/papers/architectures/highway-networks), [ResNet](/papers/architectures/deep-residual-learning), [ResNeXt](/papers/architectures/resnext), [DenseNet](/papers/architectures/densenet), [MobileNets](/papers/architectures/mobilenets), [MobileNetV2](/papers/architectures/mobilenetv2), [SENet](/papers/architectures/squeeze-and-excitation-networks), [EfficientNet](/papers/architectures/efficientnet), [U-Net](/papers/architectures/u-net), [Vision Transformer](/papers/architectures/vision-transformer), [MLP-Mixer](/papers/architectures/mlp-mixer), [MetaFormer](/papers/architectures/metaformer), [DINO](/papers/architectures/emerging-properties-in-self-supervised-vision-transformers), [MAE](/papers/architectures/masked-autoencoders-are-scalable-vision-learners), [Swin Transformer](/papers/architectures/swin-transformer), [CoAtNet](/papers/architectures/coatnet), [ConvNeXt](/papers/architectures/convnext) |
...
| Shared-weight embedding architectures | parameter-tied branches, pair/triplet geometry, distance-based outputs, open-set retrieval, mining policy, and embedding deployment | [Siamese Neural Networks](/papers/architectures/siamese-neural-networks-for-one-shot-image-recognition), [FaceNet](/papers/architectures/facenet), [CLIP](/papers/architectures/clip), [GraphSAGE](/papers/architectures/graphsage) |
| Architecture search and design automation | search spaces, controller policies, child-network evaluation, validation reward, fidelity, search budget, and deployment constraints | [Neural Architecture Search with Reinforcement Learning](/papers/architectures/neural-architecture-search-with-reinforcement-learning), [EfficientNet](/papers/architectures/efficientnet) |
...
| Conditional compute | sparse routing, expert capacity, sharded execution, scaling under fixed token compute, sparse expert LLMs, hybrid MoE backbones | [Sparsely-Gated MoE](/papers/architectures/sparsely-gated-moe), [GShard](/papers/architectures/gshard), [Switch Transformer](/papers/architectures/switch-transformer), [GLaM](/papers/architectures/glam), [Jamba](/papers/architectures/jamba) |
| Adaptation blocks | frozen backbones, low-rank updates, trainable parameter efficiency | [LoRA](/papers/architectures/lora) |
| Training-time architecture blocks | stochastic activation masking, normalization, activation scale, learned activations under dropout, residual stability, residual-stream scale control, small-batch vision normalization | [Dropout](/papers/architectures/dropout), [Maxout Networks](/papers/architectures/maxout-networks), [Batch Normalization](/papers/architectures/batch-normalization), [Group Normalization](/papers/architectures/group-normalization), [Layer Normalization](/papers/architectures/layer-normalization), [RMSNorm](/papers/architectures/root-mean-square-layer-normalization), [GELU](/papers/architectures/gelu) |
...
| --- | --- | --- |
| [Gradient-Based Learning Applied to Document Recognition](/papers/architectures/gradient-based-learning-applied-to-document-recognition) | LeNet-5 | convolution, subsampling, weight sharing, and end-to-end gradient learning for document recognition; full note started |
...
| [Squeeze-and-Excitation Networks](/papers/architectures/squeeze-and-excitation-networks) | SENet | channel descriptor, excitation MLP, input-dependent recalibration, placement/overhead analysis, and attention-axis boundaries; full paper note |
...
| [Human-level control through deep reinforcement learning](/papers/architectures/human-level-control-through-deep-reinforcement-learning) | Deep Q-Network | CNN observation encoder, action-value head, replay buffer, and target network for discrete-action control; full note started |
| [World Models](/papers/architectures/world-models) | VAE + MDN-RNN + controller | latent visual state, probabilistic recurrent dynamics, and imagined rollouts for model-based control; full note started |
| [Dream to Control: Learning Behaviors by Latent Imagination](/papers/architectures/dream-to-control-learning-behaviors-by-latent-imagination) | Dreamer | recurrent stochastic state-space model, latent imagination, and analytic actor-critic learning through imagined trajectories; full note started |
| [Mastering Atari, Go, Chess and Shogi by Planning with a Learned Model](/papers/architectures/mastering-atari-go-chess-and-shogi-by-planning-with-a-learned-model) | MuZero | task-oriented latent dynamics, reward/policy/value prediction, and MCTS without a supplied simulator; full note started |
| [Universal Transformers](/papers/architectures/universal-transformers) | recurrent-depth Transformer | shared self-attention transition, iterative representation refinement, and adaptive per-position halting; full note started |
| [BERT](/papers/architectures/bert) | encoder-only Transformer | bidirectional encoder, masked-token pretraining, segment-aware input packing, transfer heads, and objective/architecture separation; full paper note |
...
| [Gated Linear Attention Transformers with Hardware-Efficient Training](/papers/architectures/gated-linear-attention) | GLA Transformer | data-dependent gated linear attention plus hardware-aware chunkwise training; full note started |
| [Parallelizing Linear Transformers with the Delta Rule over Sequence Length](/papers/architectures/deltanet) | DeltaNet | delta-rule linear Transformer with parallel training over sequence length; full note started |
| [Griffin](/papers/architectures/griffin) | Griffin / Hawk | gated linear recurrence mixed with local attention for efficient language models; full note started |
| [Mega](/papers/architectures/mega) | moving-average equipped gated attention | EMA local bias combined with gated attention for long-sequence modeling; full note started |
...
| [Dropout](/papers/architectures/dropout) | stochastic activation masking | training-time subnetwork sampling for regularization and approximate model averaging; full note started |
| [Maxout Networks](/papers/architectures/maxout-networks) | maxout unit | learned piecewise-linear activation block designed to pair with dropout; full note started |
...
| [Neural Turing Machines](/papers/architectures/neural-turing-machines) | external differentiable memory | recurrent controller with content/location addressing and erase-add read/write operations; full note started |
| [Memory Networks](/papers/architectures/memory-networks) | modular long-term memory | separates input, generalization, output, response, and memory components for multi-step QA; full note started |
| [End-To-End Memory Networks](/papers/architectures/end-to-end-memory-networks) | multi-hop memory attention | recurrent attention over external memory with end-to-end training; full note started |
| [Hybrid Computing Using a Neural Network with Dynamic External Memory](/papers/architectures/differentiable-neural-computer) | DNC | memory allocation, temporal links, and content/forward/backward read modes; full note started |
| [Hopfield Networks is All You Need](/papers/architectures/hopfield-networks-is-all-you-need) | modern continuous Hopfield layer | associative retrieval, energy-based fixed points, and the attention correspondence; full note started |
...
| [Sequence to Sequence Learning with Neural Networks](/papers/architectures/sequence-to-sequence-learning) | LSTM seq2seq | deep LSTM encoder-decoder for variable-length sequence transduction and pre-attention neural machine translation; full note started |
| [RWKV: Reinventing RNNs for the Transformer Era](/papers/architectures/rwkv) | recurrent language model | Transformer-like parallel training with RNN-like recurrent inference and constant-size state; full note started |
| [Retentive Network](/papers/architectures/retnet) | RetNet / retention | retention mechanism with parallel, recurrent, and chunkwise recurrent forms for language-model backbones; full note started |
...
| [Highway Networks](/papers/architectures/highway-networks) | gated skip network | transform and carry gates for very deep feed-forward networks; full note started |
...
| [An Image is Worth 16x16 Words](/papers/architectures/vision-transformer) | Vision Transformer | patch tokenization, full Transformer encoder contract, positional/readout choices, data regime, scaling, and transfer limits; full paper note |
...
| [Emerging Properties in Self-Supervised Vision Transformers](/papers/architectures/emerging-properties-in-self-supervised-vision-transformers) | DINO / self-supervised ViT | teacher-student self-distillation, multi-crop views, collapse control, and emergent semantic attention behavior; full note |
...
| [Neural Architecture Search with Reinforcement Learning](/papers/architectures/neural-architecture-search-with-reinforcement-learning) | controller-generated architectures | recurrent controller, search space, child-network reward, policy gradient, and search-budget accounting; full note started |
| [Mastering Chess and Shogi by Self-Play with a General Reinforcement Learning Algorithm](/papers/architectures/mastering-chess-and-shogi-by-self-play) | AlphaZero | shared representation, policy/value heads, MCTS policy improvement, self-play targets, and planning cost; full note started |
...
| [Neural Discrete Representation Learning](/papers/architectures/neural-discrete-representation-learning) | VQ-VAE | vector-quantized discrete latent codebook, straight-through training, code usage diagnostics, and learned autoregressive prior over codes; full note |
...
| [Transformers are SSMs](/papers/architectures/mamba-2) | Mamba-2 / SSD | structured state space duality and a faster Mamba-style core layer; full note started |
| [Jamba: A Hybrid Transformer-Mamba Language Model](/papers/architectures/jamba) | hybrid Transformer-Mamba-MoE LM | interleaves attention and Mamba layers with sparse MoE feed-forward capacity for long-context language modeling; full note started |
