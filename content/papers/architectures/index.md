...
| Shared-weight embedding architectures | parameter-tied branches, pair/triplet geometry, distance-based outputs, open-set retrieval, mining policy, and embedding deployment | [FaceNet](/papers/architectures/facenet), [CLIP](/papers/architectures/clip), [GraphSAGE](/papers/architectures/graphsage) |
