...
| Detection, instance segmentation, and set prediction | proposal networks, region heads, mask heads, promptable segmentation, object queries, bipartite matching, dense prediction without NMS | [Faster R-CNN](/papers/architectures/faster-r-cnn), [Mask R-CNN](/papers/architectures/mask-r-cnn), [Segment Anything](/papers/architectures/segment-anything), [DETR](/papers/architectures/detr) |
