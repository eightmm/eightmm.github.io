...
| Training-time architecture blocks | normalization, activation scale, learned activations under dropout, residual stability, residual-stream scale control, small-batch vision normalization | [Maxout Networks](/papers/architectures/maxout-networks), [Batch Normalization](/papers/architectures/batch-normalization), [Group Normalization](/papers/architectures/group-normalization), [Layer Normalization](/papers/architectures/layer-normalization), [RMSNorm](/papers/architectures/root-mean-square-layer-normalization), [GELU](/papers/architectures/gelu) |
