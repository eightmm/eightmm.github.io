...
| Post route | Korean reader-facing synthesis has one question, one main axis, minimum formulas, and next links | Use the post workflow from the Posts section when a public essay is needed |
