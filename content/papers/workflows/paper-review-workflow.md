...
3. Write the paper-specific note using [[papers/workflows/paper-note-format|Paper note format]].
4. Extract claims using [[papers/analysis/claim-extraction|Claim extraction]].
5. Map claims to evidence using [[papers/analysis/evidence-table|Evidence table]].
6. Create a [[papers/analysis/benchmark-card|Benchmark card]] for the benchmark when the evaluation protocol matters.
7. Map component claims with [[papers/analysis/ablation-map|Ablation map]] when the paper argues why a method works.
8. Record limits with [[papers/analysis/limitation-taxonomy|Limitation taxonomy]].
9. Record public artifacts using [[papers/reproducibility/artifact-availability|Artifact availability]].
10. Check reproducibility using [[papers/reproducibility/checklist|Reproducibility checklist]].
11. Decide [[papers/reproducibility/implementation-readiness|Implementation readiness]] before spending compute.
12. Write a [[papers/reproducibility/reproduction-plan|Reproduction plan]] only if the paper is worth rerunning or reimplementing.
13. Record any rerun, reimplementation, or diagnostic as [[papers/reproducibility/reproduction-result|Reproduction result]].
14. Compare related papers with [[papers/analysis/paper-comparison-matrix|Paper comparison matrix]] when useful.
