...
Implementation readiness asks whether a paper has enough public detail to justify spending time on a reimplementation. It sits between [[papers/artifact-availability|Artifact availability]] and [[papers/reproduction-plan|Reproduction plan]].
...
- Would a failure produce a useful [[papers/reproduction-result|Reproduction result]] note?
