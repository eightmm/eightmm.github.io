...
- teacher-student SSL이라면 teacher가 EMA, frozen checkpoint, larger model, 또는 hidden data source인지 구분했는가? 예: [[papers/architectures/emerging-properties-in-self-supervised-vision-transformers|DINO]]
