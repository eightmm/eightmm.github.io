...
| Protein sequence, genome region, k-mer, variant-level prediction | Sequence-Based Modeling | Opening broad omics unless needed |
| Molecule identity, ligand role, graph, fingerprint, conformer, property | Molecular and Ligand Modeling | Using Molecular Modeling for every sequence task |
| Protein-ligand pair, target-conditioned activity, affinity, selectivity | Interaction Modeling | Collapsing target-assay context into molecule-only labels |
| Docking, pose, pocket, virtual screening | Structure-Based Modeling | Hiding coordinate assumptions inside generic AI |
...
| Interaction Modeling | relation-first tasks | activity, affinity, selectivity, protein-ligand pairs |
| Structure-Based Modeling | coordinate and complex-centered modeling | docking, pose generation, scoring, virtual screening |
...
| Question | Route |
| --- | --- |
| What is being modeled? | [Objects and Entities](/molecular-modeling/entities) |
| Is the primary input a biological sequence? | [Sequence-based modeling](/molecular-modeling/sequence-based) |
| Is the primary object a molecule or ligand state? | [Molecular and ligand modeling](/molecular-modeling/molecular-ligand) |
| Is the example a pair, assay row, affinity, or selectivity claim? | [Interaction modeling](/molecular-modeling/interactions) |
...
| Ligand conformer generation | [Molecular and ligand modeling](/molecular-modeling/molecular-ligand) | [Conformer](/concepts/molecular-modeling/conformer), [Coordinate modeling contract](/concepts/geometric-deep-learning/coordinate-modeling-contract) |
...
| Molecular graph pretraining | [Molecular and ligand modeling](/molecular-modeling/molecular-ligand) | [Self-supervised learning](/ai/learning-methods), [Graph neural networks](/concepts/architectures/gnn) |
| Flow-matching molecule generation | [Molecular and ligand modeling](/molecular-modeling/molecular-ligand) | [Flow matching](/concepts/generative-models/flow-matching), [Generative models](/ai/generative-models) |
