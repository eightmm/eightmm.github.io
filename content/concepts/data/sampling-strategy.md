...
Sampling strategy defines which examples enter the dataset and how batches are drawn during training or evaluation. It controls class balance, domain coverage, temporal bias, and rare-case visibility.
