...
- Task path: [[concepts/tasks/task-specification|Task specification]] -> [[concepts/tasks/task-output-space|Task output space]] -> [[concepts/tasks/retrieval|Retrieval]] -> [[concepts/tasks/question-answering|Question answering]] -> [[concepts/tasks/sequence-generation|Sequence generation]] -> [[concepts/tasks/structured-prediction|Structured prediction]]
