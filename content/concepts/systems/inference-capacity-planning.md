...
Inference capacity planning estimates how many requests a model can serve under a latency, throughput, memory, and quality target. It connects [[concepts/systems/inference-serving|Inference serving]], [[infra/gpu/index#memory|GPU memory]], and [[concepts/systems/latency-throughput|Latency and throughput]].
