...
AI, computational biology, Math가 함께 나오는 글은 [[posts/workflows/ai-molecular-math-post-intake|AI Computational Biology Math 포스트 인테이크]]로 먼저 중심축을 정합니다. 실제 post로 승격할지는 [[posts/workflows/post-promotion-gate|Post promotion gate]]로 확인합니다.
...
Wiki note가 충분히 쌓였을 때만 post로 승격합니다. 자세한 흐름은 [[posts/essays/wiki-to-post-workflow|Wiki에서 Post로 승격하는 방식]], [[posts/workflows/post-promotion-gate|Post promotion gate]], [[agents/workflows/content-promotion-workflow|Content promotion workflow]]를 따릅니다.
...
- [[posts/index|Posts]]
- [[posts/workflows/topic-roadmap|Topic roadmap]]
- [[posts/workflows/ai-molecular-math-post-intake|AI Computational Biology Math 포스트 인테이크]]
...
- [[posts/essays/blog-and-wiki-workflow|블로그와 위키를 같이 쓰는 방식]]
