...
AI, molecular modeling, Math가 함께 나오는 글은 [[posts/ai-molecular-math-post-intake|AI-Molecular-Math 포스트 인테이크]]로 먼저 중심축을 정합니다. 실제 post로 승격할지는 [[posts/post-promotion-gate|Post promotion gate]]로 확인합니다.
