...
- [[molecular-modeling/index|Molecular Modeling]]: structure-based modeling, protein, molecule, ligand 중심의 지도
...
2. [[molecular-modeling/index|Molecular Modeling]]에서 적용 대상을 봅니다.
...
1. [[molecular-modeling/index|Molecular Modeling]]
...
그래서 agent 작업은 [[agents/verification/verification-loop|Verification loop]], [[agents/verification/human-in-the-loop|Human in the loop]], [[agents/core/context-engineering|Context engineering]] 같은 원칙을 따릅니다.

초안은 바로 공개 글이 되지 않습니다. [[inbox/inbox-triage|Inbox triage]]를 거치고, 공개할 수 있는 기록은 [[logs/sanitization-checklist|Sanitization checklist]]로 정리한 뒤 [[logs/public-log-format|Public log format]]에 맞춰 남깁니다.
